# -*- coding: utf-8 -*-
"""full_seq2seq_pipeline.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/14y2UYemwpYcUmAn5vZmGj4-iMadyEC_Y
...
# --- Data Preparation (Re-download and reload) ---
print("Downloading dataset...")
path = kagglehub.dataset_download("olaolabenjo/englishyoruba-parallel-corpus-sample")
print(f"Dataset downloaded to: {path}")

df = pd.read_csv(f"{path}/yoruba_english_parallel_sample.csv")
...
# (Re-running this to ensure embeddings are generated in the current environment if needed,
# though num_layers change doesn't affect CBOW)
...
encoder = Encoder(
    ...
    emb_dim=40,
    hidden_dim=256,
    num_layers=4 # Explicitly set num_layers to 4
).to(device)
